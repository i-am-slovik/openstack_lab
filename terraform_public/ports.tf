...
locals {
  ...
  slovik_internal_management_ports_map = {
    "slovik_internal_https_ingress_node_port" = var.internal_ips.internal_https_ingress_node
    "slovik_internal_jumpbox_port"            = var.internal_ips.internal_jumpbox
    "slovik_zabbix_port"                      = var.internal_ips.zabbix
