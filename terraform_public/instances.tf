...
resource "openstack_compute_instance_v2" "slovik_ingress_node" {
  ...
  network {
    port = data.openstack_networking_port_v2.slovik_dmz_ports["slovik_ingress_node"].id
  }
...
resource "openstack_compute_instance_v2" "slovik_jumpbox" {
  ...
  network {
    port = data.openstack_networking_port_v2.slovik_dmz_ports["slovik_jumpbox"].id
  }
